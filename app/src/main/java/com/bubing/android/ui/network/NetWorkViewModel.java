...
import com.bubing.mvvm.http.ResponseThrowable;
 ...
 */
public class NetWorkViewModel extends BaseViewModel<RepositoryModel> {
    ...
    public NetWorkViewModel(@NonNull Application application, RepositoryModel repository) {
        ...
        public void call() {
            ...
            model.loadMore()
                    ...
                    .subscribe(new Consumer<LoginEntity>() {
                        @Override
                        public void accept(LoginEntity entity) throws Exception {
                            for (LoginEntity.ItemsEntity itemsEntity : entity.getItems()) {
    ...
    public void requestNetWork() {
        ...
        model.demoGet()
                ...
                .subscribe(new DisposableObserver<BaseResponse<LoginEntity>>() {
                    @Override
                    public void onNext(BaseResponse<LoginEntity> response) {
                        ...
                        if (response.getCode() == 1) {
                            for (LoginEntity.ItemsEntity entity : response.getResult().getItems()) {
