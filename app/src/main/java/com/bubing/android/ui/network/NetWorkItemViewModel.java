...
import com.bubing.android.ui.network.detail.DetailFragment;
...
/**
 * @ClassName: NetWorkItemViewModel
 * @Description: java类作用描述
 * @Author: Bubing
 * @Date: 2020/8/3 3:49 PM
 */
public class NetWorkItemViewModel extends ItemViewModel<NetWorkViewModel> {
    ...
    public NetWorkItemViewModel(@NonNull NetWorkViewModel viewModel, LoginEntity.ItemsEntity entity) {
        super(viewModel);
