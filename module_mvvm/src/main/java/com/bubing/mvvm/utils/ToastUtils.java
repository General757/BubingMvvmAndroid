...
public class ToastUtils {
    ...
    public static void setView(@LayoutRes int layoutId) {
        ...
        sViewWeakReference = new WeakReference<View>(inflate.inflate(layoutId, null));
    }
    ...
    public static void setView(@Nullable View view) {
        sViewWeakReference = view == null ? null : new WeakReference<View>(view);
    }
